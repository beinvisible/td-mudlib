/* SilberLand MUDlib
 *
 * /secure/room_locator.c -- room locator object
 *
 * $Date: 1997/03/15 23:42:43 $
 * $Revision: 1.1 $
 * $Log: room_locator.c,v $
 * Revision 1.1  1997/03/15 23:42:43  Woody
...
updall(all)
{
  ...
  tell_object(find_player("debugger"),sprintf("%d left\n",sizeof(all)));
  if (sizeof(all)>25)
  {
    todo=all[0..24];
