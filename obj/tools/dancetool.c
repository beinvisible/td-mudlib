...
int query_add_details( string str )
{
   ...
   write( "Filegröße:      "+file_size( actual_file )+"\n" );
...
int set_add_detail( string str )
{
   ...
   write( "Details found:    "+counter+".\n" );
   write( "-----------------------------------------------------------------------------\n" ); 
   write( "Bitte die Detail-Kürzel eingeben:\n(Bemerkung: "+
          "die Kürzel müssen mit Leerzeichen getrennt sein, "+
          "Abbruch mit 'q'.)\n->" );
...
int get_detail_short( string str )
{
   ...
   write( "-----------------------------------------------------------------------------\n" );
   write( bs ( "Bitte Beschreibung eingeben für das Detail mit den Namen \n" ) );
