// SilberLand MUDlib
//
// /p/daemon/htmld.c -- interpretes HTML encoded files
//
// $Date: 1997/03/16 02:27:54 $
/* $Revision: 1.2 $
 * $Log: htmld.c,v $
 * Revision 1.2  1997/03/16 02:27:54  Woody
...
mixed ReadPage(string file, mapping page_info, int ANSI)
{
  ...
  if(sizeof(file) < 6 || file[<5..] != ".html") return NO_HTML_FILE;
  if(!stringp(src = read_file(file)) || !sizeof(src)) return EMPTY_FILE;
