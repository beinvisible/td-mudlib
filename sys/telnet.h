...
//
// $Log: telnet.h,v $
// Revision 1.16  2016/08/15 13:55:02  Holger
// added handle_gmcp() prototype
//
// Revision 1.15  2016/08/15 13:20:17  Holger
// added sb_gmcp()
//
// Revision 1.14  2016/08/15 12:41:33  Holger
// revert last change
//
// Revision 1.12  2016/08/13 21:21:17  Holger
// added TELOPT_GMCP
//
// Revision 1.11  2004/02/27 08:37:35  Fiona
// TELOPT_CHARSET new
//
...
static void handle_gmcp(int* data); // std/player/gmcp.c
#endif
...
#define TELOPT_GMCP     201     /* GMCP, http://www.gammon.com.au/gmcp */
...
#define CS_FLAGNAME(x)                                           \
    (x > 0 && x < 8 ?                                            \
       ({ "REQUEST", "ACCEPTED", "REJECTED", "TTABLE_IS",        \
          "TTABLE_REJECTED", "TTABLE_ACK", "TTABLE_NAK" })[x-1]  \
     : ""+x)
